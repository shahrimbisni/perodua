...
<div class="container">
    <div class="middle-align">
        <?php
            ...
            <div class="row">
                ...
                <div id="our-services" class="services col-md-8">
                    <h1 class="entry-title"><?php printf( esc_html('Results For: %s', 'vw-automobile-lite' ), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>      
                    <?php if ( have_posts() ) :
                    /* Start the Loop */
        ...
        <?php }else if($left_right == 'Grid Layout'){ ?>
            <div class="row">
                <div id="our-services" class="row services col-md-9">
                    <h1 class="entry-title"><?php printf( esc_html('Results For: %s', 'vw-automobile-lite' ), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
                    <?php if ( have_posts() ) :
                        /* Start the Loop */

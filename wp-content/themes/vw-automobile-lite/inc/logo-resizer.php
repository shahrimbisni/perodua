...
function vw_automobile_lite_customize_preview_js() {
	wp_enqueue_script( 'vw-automobile-lite-customizer', get_template_directory_uri() . '/js/logo/customize-preview.js', array( 'jquery', 'customize-preview' ), '201709081119', true );
}
...
function vw_automobile_lite_customize_controls_js() {
		wp_enqueue_script( 'vw-automobile-lite-customizer-controls', get_template_directory_uri() . '/js/logo/customize-controls.js', array( 'jquery', 'customize-preview' ), '201709071000', true );
}

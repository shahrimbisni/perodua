...
<div class="wrapper-info">
    ...
    <div class="col-right">
		...
		<div class="update-now">
			<h4><?php esc_html_e('Buy VW Automobile at 10% Discount','vw-automobile-lite'); ?></h4>
			<h4><?php esc_html_e('Use Coupon','vw-automobile-lite'); ?> ( <span><?php esc_html_e('vwten2018','vw-automobile-lite'); ?></span> ) </h4> 
			<div class="info-link">
    ...
    <div class="tab-sec">
		...
		<div id="lite_theme" class="tabcontent open">
		  	...
		  	<div class="col-left-inner">
				...
				<div class="link-customizer">
					...
					<div class="first-row">
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-format-image"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[control]=custom_logo') ); ?>" target="_blank"><?php esc_html_e('Upload your logo','vw-automobile-lite'); ?></a>
							</div>
							<div class="row-box2">
								<span class="dashicons dashicons-admin-customizer"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_automobile_lite_typography') ); ?>" target="_blank"><?php esc_html_e('Typography','vw-automobile-lite'); ?></a>
							</div>
						</div>
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-images-alt"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_automobile_lite_slidersettings') ); ?>" target="_blank"><?php esc_html_e('Slider Settings','vw-automobile-lite'); ?></a>
							</div>
							<div class="row-box2">
								<span class="dashicons dashicons-align-center"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_automobile_lite_topbar_icon') ); ?>" target="_blank"><?php esc_html_e('Topbar Settings','vw-automobile-lite'); ?></a>
							</div>
						</div>
						<div class="row-box">
							<div class="row-box1">
							...
							<div class="row-box2">
								<span class="dashicons dashicons-editor-aligncenter"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[panel]=nav_menus') ); ?>" target="_blank"><?php esc_html_e('Menus','vw-automobile-lite'); ?></a>
							</div>
						</div>
						<div class="row-box">
							<div class="row-box1">
							...
							<div class="row-box2">
								<span class="dashicons dashicons-admin-page"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=static_front_page') ); ?>" target="_blank"><?php esc_html_e('Set Home Page','vw-automobile-lite'); ?></a>
							</div>
						</div>
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-welcome-write-blog"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_automobile_lite_left_right') ); ?>" target="_blank"><?php esc_html_e('Blog Layout','vw-automobile-lite'); ?></a>
							</div>
							<div class="row-box2">
								<span class="dashicons dashicons-align-center"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_automobile_lite_footer') ); ?>" target="_blank"><?php esc_html_e('Footer Text','vw-automobile-lite'); ?></a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="col-right-inner">
                ...
                <ul>
                	<li><?php esc_html_e('1. Create a Page to set template:  Go to ','vw-automobile-lite'); ?>
                  	<b><?php esc_html_e('Dashboard &gt;&gt; Pages &gt;&gt; Add New Page','vw-automobile-lite'); ?></b>.
                  	<p><?php esc_html_e('Label it "home" or anything as you wish. Then select template "home-page" from template dropdown.','vw-automobile-lite'); ?></p></li>
                  	<img src="<?php echo esc_url(get_template_directory_uri()); ?>/inc/getting-started/images/home-page-template.png" alt="" />
                  	<p></p><span class="strong"><?php esc_html_e('2. Set the front page:','vw-automobile-lite'); ?></span><?php esc_html_e(' Go to ','vw-automobile-lite'); ?>
				  	<b><?php esc_html_e(' Settings -&gt; Reading --&gt; Set the front page display static page to home page ','vw-automobile-lite'); ?></b></p>
                  	<img src="<?php echo esc_url(get_template_directory_uri()); ?>/inc/getting-started/images/set-front-page.png" alt="" />
                  	<p><?php esc_html_e(' Once you are done with this, you can see all the demo content on front page. ','vw-automobile-lite'); ?></p>
                </ul>
		  	</div>
		</div>	
		...
		<div id="pro_theme" class="tabcontent">
		    ...
		    <div class="col-left-pro">
		    	...
		    	<div class="pro-links">
					...
					<a href="<?php echo esc_url( VW_AUTOMOBILE_LITE_BUY_NOW ); ?>"><?php esc_html_e('Buy Pro', 'vw-automobile-lite'); ?></a>
		...
		<div id="free_pro" class="tabcontent">
		  	...
		  	<div class="col-3">
				...
				<div class="info-link">
					<a href="<?php echo esc_url( VW_AUTOMOBILE_LITE_DEMO_DATA ); ?>" target="_blank"><?php esc_html_e('Demo Content', 'vw-automobile-lite'); ?></a>
				</div>
		  	</div>
		</div>
	</div>

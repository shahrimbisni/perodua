...
function vw_automobile_lite_categorized_blog() {
	...
	if ( '1' != $vw_automobile_lite_all_the_cool_cats ) {
		// This blog has more than 1 category so vw_automobile_lite_categorized_blog should return true
		return true;
	} else {
		// This blog has only 1 category so vw_automobile_lite_categorized_blog should return false
		return false;
	}
}
...
/**
 * Flush out the transients used in vw_automobile_lite_categorized_blog
 */
